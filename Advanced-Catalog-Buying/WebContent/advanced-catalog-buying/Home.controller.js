			    ...
			    + '<Message>'
			       ...
			       + '     <PunchOutOrderMessageHeader operationAllowed="edit">'
			            ...
			            + '<ItemIn quantity="3">'
			                ...
			                + '</ItemDetail>'
			                + '<Tax>'
								+ '<Money currency="BRL">120.12</Money>'
								+ '<Description xml:lang="en">ICMS base 66%</Description>'
							+ '</Tax>'
							+ '<Tax>'
								+ '<Money currency="BRL">25.90</Money>'
								+ '<Description xml:lang="en">IPI base 100%</Description>'
							+ '</Tax>'
							+ '<Tax>'
								+ '<Money currency="BRL">100.00</Money>'
								+ '<Description xml:lang="en">Frete (ZFREI)</Description>'
							+ '</Tax>'
			            + '</ItemIn>'
			        + '</PunchOutOrderMessage>'
			    + '</Message>'

	...
	getcXML : function() {
		...
		var sXML = 
			...
			+ '      <From>'
			        ...
			        + '<To>'
			            + '<Credential domain="NetworkId">'
			                + '<Identity>AN01425473740-T</Identity>'
			            + '</Credential>'
			        + '</To>'
			        + '<Sender>'
			            ...
			            + '</Credential>'
			            + '<UserAgent>Stratesys cXML Application</UserAgent>'
			        + '</Sender>'
			    + '</Header>'
			    + '<Message>'
			            ...
			            + '<ItemIn quantity="3">'
			                ...
			                + '<ItemDetail>'
			                    + '<UnitPrice>'
			                        + '<Money currency="BRL">763.20</Money>'
			                    + '</UnitPrice>'
			                    + '<Description xml:lang="pt_BR">Cadeira reclinavel de couro com braços acolchoados | Cor selecionada: Amarelo | Entrega em: Depósito: C1900 - Endereço : ABC 90 Porto Alegre-RS</Description>'
